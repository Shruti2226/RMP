...
function ResultInfo() {
  ...
  return (
    <div className="primary2">
      <PageTitle title="Result Information" />
      {result && (
        <>
          <div className=" card2">
          ...
          {!selectedStudent ? (
            ...
            <>
              <div className="d-flex justify-content-between align-items-center card2 flex-row p-2">
              ...
              <button onClick={saveStudentResult} className="button-7 px-5 ">
                SAVE
              </button>
            </>
          )}
